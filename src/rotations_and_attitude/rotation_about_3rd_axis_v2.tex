...
\begin{document}
    ...
    \begin{tikzpicture}[tdplot_main_coords,scale=1]
        ...
        \draw[dotted,thick](0,0,0)--(0,0,3)node[pos=1.1]{$x_{3}$, $x_{3}'$};
        ...
        % x1'x2'x3' axes
        \draw[tdplot_rotated_coords](0,0,0)--(3,0,0)node[pos=1.17]{$x_{1}'$};
        \draw[tdplot_rotated_coords](0,0,0)--(0,3,0)node[pos=1.09]{$x_{2}'$};
