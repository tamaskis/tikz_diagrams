...
\begin{document}
    ...
    \begin{tikzpicture}[declare function={
        ...
        % x-axis labels
        \node at(xa,-0.4){$x_{i-1}$};
        \node at(xb,-0.4){$x_{i}$};
        \node at(xc,-0.4){$x_{i+1}$};
        
        % plots evaluation points
        \draw[black,fill=white,thick](xa,\fa)circle(0.08)node[above,xshift=-5,yshift=1]{$y_{i-1}$};
        \draw[black,fill=white,thick](xb,\fb)circle(0.08)node[above,yshift=1]{$y_{i}$};
        \draw[black,fill=white,thick](xc,\fc)circle(0.08)node[above,xshift=4,yshift=1]{$y_{i+1}$};
