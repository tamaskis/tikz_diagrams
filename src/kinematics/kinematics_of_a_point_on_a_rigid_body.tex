...
\begin{document}
    ...
    \begin{tikzpicture}[tdplot_main_coords,scale=1]
        ...
        \begin{scope}[x={(image.south east)},y={(image.north west)}]
            ...
            % World axes.
            \draw[tdplot_rotated_coords,thick](\Oxw,\Oyw,\Ozw)--(\Oxw+\axlen,\Oyw,\Ozw)node[pos=1.1]{$x_{w}$};
            \draw[tdplot_rotated_coords,thick](\Oxw,\Oyw,\Ozw)--(\Oxw,\Oyw+\axlen,\Ozw)node[pos=1.12]{$y_{w}$};
            \draw[tdplot_rotated_coords,thick](\Oxw,\Oyw,\Ozw)--(\Oxw,\Oyw,\Ozw+\axlen)node[pos=1.08]{$z_{w}$};
        ...
        \begin{scope}[x={(image.south east)},y={(image.north west)}]
            ...
            % Body axes.
            \draw[tdplot_rotated_coords,color_theme,line width=0.5mm](\Oxb,\Oyb,\Ozb)--(\Oxb+\axlen,\Oyb,\Ozb)node[pos=1.08]{$x_{b}$};
            \draw[tdplot_rotated_coords,color_theme,line width=0.5mm](\Oxb,\Oyb,\Ozb)--(\Oxb,\Oyb+\axlen,\Ozb)node[pos=1.1]{$y_{b}$};
            \draw[tdplot_rotated_coords,color_theme,line width=0.5mm](\Oxb,\Oyb,\Ozb)--(\Oxb,\Oyb,\Ozb-\axlen)node[pos=1.08]{$z_{b}$};
            ...
            % Center of mass.
            \node[draw=none,shape=circle,fill,inner sep=1.75pt,color_theme,tdplot_rotated_coords](d1)at(\Oxb,\Oyb,\Ozb){};
            \node[xshift=-9,yshift=-5,color_theme,tdplot_rotated_coords]at(\Oxb,\Oyb,\Ozb){$\mathrm{cm}$};
