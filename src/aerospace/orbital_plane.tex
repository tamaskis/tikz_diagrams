...
\begin{document}
    ...
    \begin{tikzpicture}[scale=3,tdplot_main_coords]
        ...
        % Position vector.
        \draw[-mylatex',thick,/tiplen=0.3cm](1.5,0.5,0)--(0.5,1.25,0)node[anchor=west,xshift=-25,yshift=2]{$\boldsymbol{r}$};
        
        % angular momentum unit vector
        \draw[-mylatex',thick,/tiplen=0.3cm](1.5,0.5,0)--(1.5,0.5,0.8)node[anchor=west,xshift=-7,yshift=7]{$\boldsymbol{h}$};
        
        % eccentricity vector
        \draw[-mylatex',thick,/tiplen=0.3cm](1.5,0.5,0)--(1.5,1.25,0)node[anchor=west,xshift=-20,yshift=-5]{$\boldsymbol{e}$};
        ...
        % trajectory label
        \draw[thin](0.18,0.8,0)--(-1,1,0)node[anchor=west]{trajectory \textit{(described by conic section)}};

        % central body label
        \draw[thin](1.55,0.53,0)--(2.75,1.5,0)node[anchor=west]{central body \textit{(primary focus of conic section)}};
